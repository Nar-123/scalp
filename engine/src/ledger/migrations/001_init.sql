-- Reference copy only. The migration actually executed at runtime is the
-- identical string in 001_init.ts (kept as TS so it ships in dist/ without
-- a separate asset-copy build step). Keep both in sync if you edit the schema.
